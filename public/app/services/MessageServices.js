...
messageServices.factory('Message', ['$resource', function ($resource) {
        return $resource('api/messages/:to_id_user_profile/:from_id_user_profile', {}, {
            ...
            getMessageToFrom: { method: 'GET', params: { to_id_user_profile: '@to_id_user_profile', from_id_user_profile: '@from_id_user_profile' }, isArray: true },
            addMessageTo: { method: 'POST', params: { to_id_user_profile: '@to_id_user_profile' } },
